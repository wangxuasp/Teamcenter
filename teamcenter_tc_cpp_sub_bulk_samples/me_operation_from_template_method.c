/*HEAD ME_OPERATION_FROM_TEMPLATE_METHOD.CXX CCC ITK */
/*
To build custom shared library on Windows:
%TC_ROOT%\sample\compile -DIPLIB=none me_operation_from_template_method.cxx
...
$TC_ROOT/sample/compile me_operation_from_template_method.cxx
$TC_ROOT/sample/link_custom_exits gtac_custom_exits
...
extern DLLAPI int process_from_template(METHOD_message_t *msg, va_list args)
{
    ...
    ECHO( "   Object Type: MEOperationRevision \n");
